...
const NavBar = () => {
    ...
    const [cav, setCav] = useState(false);
  ...
  return (
   ...
   px-4 text-white bg-black fixed">
        <div>
            <h1 className="text-5xl font-signature ml-2">Clark</h1>
        </div>
        ...
        pr-4 z-10 text-gray-500 
        md:hidden"
        >
            {cav ? <FaTimes size={30} /> : <FaBars size={30} />}
